 ...
 *
 */
class DishesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'slug' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'restaurant_id' => ['type' => 'unique', 'columns' => ['restaurant_id', 'slug'], 'length' => []],
            'dishes_ibfk_1' => ['type' => 'foreign', 'columns' => ['restaurant_id'], 'references' => ['restaurants', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => '2018-06-24 18:45:04',
                'updated_at' => '2018-06-24 18:45:04'
            ],
        ];
        parent::init();
    }
