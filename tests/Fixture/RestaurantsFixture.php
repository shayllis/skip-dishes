...
class RestaurantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'slug' => ['type' => 'string', 'length' => 60, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'photo' => ['type' => 'string', 'length' => 144, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'description' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'lat' => ['type' => 'decimal', 'length' => 9, 'precision' => 4, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'long' => ['type' => 'decimal', 'length' => 9, 'precision' => 4, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'lat' => 1.5,
                'long' => 1.5,
                'created_at' => '2018-06-24 17:15:46',
                'updated_at' => '2018-06-24 17:15:46'
            ],
        ];
        parent::init();
    }
